...
function Settings() {
  ...
  return (
    <div className="bg-neutral-50 dark:bg-neutral-900 pb-20">
      <Header />
      <main className="container mx-auto px-4 py-4" style={{ minHeight: 'calc(100vh - 4rem)' }}>
        <div className="mb-4">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="home">AI</SelectItem>
